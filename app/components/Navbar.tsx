    ...
    <>
            ...
            {navItems.map((item) => (
              <li key={item.href}>
                <Link href={item.href} style={{
                  ...
                  color: isActive(item.href) ? "var(--gold)" : "var(--slate-mid)",
                  textDecoration: "none", fontWeight: isActive(item.href) ? 700 : 500,
      ...
      {mobileOpen && (
        <div style={{
          ...
          <button onClick={() => setMobileOpen(false)} style={{ position: "absolute", top: 20, right: 24, background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.7)" }}>
            <X size={26} />
          </button>
          ...
          {[...navItems, { label: "Contact", href: "/#contact" }].map((item) => (
            <Link key={item.href} href={item.href} onClick={() => setMobileOpen(false)} style={{
              ...
              color: isActive(item.href) ? "var(--gold-light)" : "rgba(255,255,255,0.75)",
          ...
          <Link href="/#contact" onClick={() => setMobileOpen(false)} style={{
            ...
            textTransform: "uppercase", textDecoration: "none", textAlign: "center", borderRadius: 2, fontWeight: 600,
          }}>
