...
export const practiceAreas: PracticeArea[] = [
  ...
  },
  {
    ...
    metaTitle: "Intellectual Property Law Services — IM & Associates, Agra",
    metaDescription: "Intellectual property law services in Agra. Trademark registration, copyright protection, patent filing, IP enforcement. Legal knowledge on IP matters by IM & Associates.",
    heroLaw: "TM Act 1999 · Patents Act 1970",
    overview: "Intellectual property (IP) law in India protects creations of the mind — inventions, brand names, literary and artistic works, designs, and trade secrets. The primary IP legislation includes the Trade Marks Act 1999, Copyright Act 1957, Patents Act 1970, Designs Act 2000, and the Geographical Indications of Goods (Registration and Protection) Act 1999.",
    legislation: ["Trade Marks Act 1999", "Copyright Act 1957", "Patents Act 1970", "Designs Act 2000", "Geographical Indications Act 1999"],
    courts: ["Intellectual Property Division — High Courts", "CGPDTM", "Copyright Board", "IPAB (now subsumed in High Courts)"],
    keyAreas: [
      { heading: "Trademark Registration", body: "A trademark protects your brand name, logo, slogan, or distinctive sign. Registration under the Trade Marks Act 1999 grants exclusive rights for 10 years (renewable). Trademark search is essential before filing to check availability across 45 classes." },
      { heading: "Copyright Protection", body: "Copyright under the Copyright Act 1957 arises automatically on creation of an original work — no registration is required. It protects literary, artistic, musical, and cinematographic works for the lifetime of the author plus 60 years." },
      { heading: "Patent Filing", body: "A patent under the Patents Act 1970 protects inventions that are novel, involve an inventive step, and are industrially applicable. Patent protection lasts 20 years from the date of filing. India follows a first-to-file system." },
    ],
    commonScenarios: [
      { scenario: "Someone copied your brand name or logo", explanation: "File a trademark infringement action under Section 29 of the Trade Marks Act 1999. An interim injunction can be sought immediately from the High Court to stop further infringement." },
      { scenario: "Your creative work was used without permission", explanation: "Copyright infringement under Section 51 Copyright Act 1957 allows civil and criminal remedies. A cease and desist notice is typically the first step, followed by suit if necessary." },
    ],
    faqs: [
      { q: "How long does trademark registration take in India?", a: "The trademark registration process in India typically takes 18–36 months. After filing, examination takes 3–6 months. If objections are raised, a hearing is scheduled. After examination, the mark is published in the Trademark Journal for a 4-month opposition window. If no opposition is filed or decided in applicant's favour, the registration certificate is issued." },
      { q: "Is copyright registration mandatory in India?", a: "No. Copyright protection arises automatically upon creation of an original work under the Copyright Act 1957 — no registration is required. However, voluntary registration with the Copyright Office provides a public record and serves as prima facie evidence in infringement proceedings." },
    ],
    relatedBlogs: ["intellectual-property-india-trademark-copyright-patent", "startup-legal-structure-india-guide"],
  },
  {
    slug: "contract-law",
    icon: "📋",
    title: "Contract Law",
    metaTitle: "Contract Law Services — IM & Associates, Agra",
    metaDescription: "Contract law services in Agra. Contract drafting, review, breach of contract, specific performance. Legal knowledge on contract matters under Indian Contract Act 1872 by IM & Associates.",
    heroLaw: "Indian Contract Act 1872",
    overview: "Contract law in India is primarily governed by the Indian Contract Act 1872, which defines the essential elements of a valid contract, the rules of offer and acceptance, consideration, capacity, free consent, and the consequences of breach. The Specific Relief Act 1963 governs enforcement of contracts through specific performance and injunctions.",
    legislation: ["Indian Contract Act 1872", "Specific Relief Act 1963", "Sale of Goods Act 1930", "Transfer of Property Act 1882"],
    courts: ["Civil Court", "High Court", "Arbitral Tribunal"],
    keyAreas: [
      { heading: "Contract Drafting & Review", body: "A well-drafted contract clearly defines the rights, obligations, timelines, payment terms, dispute resolution mechanism, and termination clauses of all parties. Poor drafting is the most common cause of commercial disputes." },
      { heading: "Breach of Contract", body: "A breach of contract occurs when a party fails to perform their contractual obligations. Remedies under Indian Contract Act 1872 include damages (Section 73-74), specific performance (Specific Relief Act 1963), and injunctions." },
      { heading: "Arbitration & Dispute Resolution", body: "Most commercial contracts include an arbitration clause under the Arbitration and Conciliation Act 1996. Arbitration provides a faster, confidential, and binding alternative to court litigation for contractual disputes." },
    ],
    commonScenarios: [
      { scenario: "Other party not honouring the contract", explanation: "Send a legal notice citing the specific breach and the remedy sought. If not resolved, file a civil suit for damages or specific performance depending on the nature of the contract." },
      { scenario: "Contract signed under pressure or fraud", explanation: "A contract entered into under coercion, undue influence, misrepresentation, or fraud is voidable at the option of the aggrieved party under Sections 14–19 of the Indian Contract Act 1872." },
    ],
    faqs: [
      { q: "Is a verbal contract legally valid in India?", a: "Yes. A verbal contract is legally valid under the Indian Contract Act 1872 if all essential elements are present — offer, acceptance, consideration, capacity, and free consent. However, verbal contracts are difficult to prove in court. Written contracts are strongly recommended for all significant transactions." },
      { q: "What is liquidated damages in Indian contract law?", a: "Under Section 74 of the Indian Contract Act 1872, parties can pre-agree a sum payable in case of breach (liquidated damages). Courts award a reasonable compensation not exceeding the stipulated amount — they do not treat it as a penalty to be automatically enforced. The actual loss must still be proved." },
    ],
    relatedBlogs: ["startup-legal-structure-india-guide", "consumer-protection-act-2019-complaint-guide"],
  },
  {
    slug: "taxation-law",
    icon: "💰",
    title: "Taxation Law",
    metaTitle: "Taxation Law Services — IM & Associates, Agra",
    metaDescription: "Taxation law services in Agra. Income tax disputes, GST matters, assessment proceedings, tax advisory. Legal knowledge on taxation matters by IM & Associates.",
    heroLaw: "IT Act 1961 · GST Act 2017",
    overview: "Taxation law in India covers direct taxes (income tax, corporate tax, capital gains) governed by the Income Tax Act 1961, and indirect taxes (GST) governed by the Central Goods and Services Tax Act 2017. Tax disputes are adjudicated by Income Tax Appellate Tribunals (ITAT), GST Appellate Authorities, and ultimately by High Courts and the Supreme Court.",
    legislation: ["Income Tax Act 1961", "Central Goods and Services Tax Act 2017", "Customs Act 1962", "Black Money Act 2015"],
    courts: ["Commissioner of Income Tax (Appeals)", "ITAT — Income Tax Appellate Tribunal", "GST Appellate Authority", "High Court", "Supreme Court"],
    keyAreas: [
      { heading: "Income Tax Disputes", body: "Income tax disputes arise from assessment orders, reassessment notices, and demand notices issued by the Income Tax Department. The appeals process goes from CIT(A) to ITAT to High Court to Supreme Court." },
      { heading: "GST Matters", body: "GST disputes cover classification of goods/services, input tax credit (ITC) disputes, refund claims, and show cause notices. GST appellate proceedings go from Appellate Authority to GSTAT to High Court." },
      { heading: "Tax Planning & Compliance", body: "Legal tax planning involves structuring transactions to minimise tax liability within the law. Legitimate tax planning (avoidance) is distinguished from tax evasion, which is a criminal offence under Section 276C of the Income Tax Act." },
    ],
    commonScenarios: [
      { scenario: "Received an income tax notice", explanation: "Do not ignore any income tax notice. Identify whether it is a Section 143(1) intimation, 143(2) scrutiny notice, 147 reassessment notice, or 148A notice. Each has different time limits for response and different legal consequences." },
      { scenario: "GST refund wrongly rejected", explanation: "A wrongful rejection of a GST refund claim can be challenged before the Appellate Authority under Section 107 CGST Act within 3 months of the order. Further appeal lies to the GST Appellate Tribunal." },
    ],
    faqs: [
      { q: "What is the difference between tax avoidance and tax evasion in India?", a: "Tax avoidance is the legal use of the tax code to reduce tax liability — it is permissible. Tax evasion is the deliberate concealment of income or furnishing of false information to reduce tax — it is a criminal offence under Section 276C of the Income Tax Act 1961, punishable with imprisonment of up to 7 years." },
      { q: "What is the General Anti-Avoidance Rule (GAAR) in India?", a: "GAAR under Chapter X-A of the Income Tax Act 1961 (in force since April 2017) allows tax authorities to disregard or recharacterise arrangements that are primarily entered into for the purpose of obtaining a tax benefit and lack commercial substance. GAAR can override treaty benefits in appropriate cases." },
    ],
    relatedBlogs: ["startup-legal-structure-india-guide"],
  },
  {
    slug: "divorce-law",
    icon: "🔨",
    title: "Divorce Law",
    metaTitle: "Divorce Law Services — IM & Associates, Agra",
    metaDescription: "Divorce law services in Agra. Mutual consent divorce, contested divorce, alimony, child custody. Legal knowledge on divorce under Hindu Marriage Act 1955 by IM & Associates.",
    heroLaw: "HMA 1955 · SMA 1954",
    overview: "Divorce law in India is religion-specific. For Hindus, Buddhists, Jains, and Sikhs — the Hindu Marriage Act 1955 applies. For Muslims — Muslim personal law and the Dissolution of Muslim Marriages Act 1939. For Christians — the Divorce Act 1869. For inter-religion marriages — the Special Marriage Act 1954. Family Courts established under the Family Courts Act 1984 handle most matrimonial matters.",
    legislation: ["Hindu Marriage Act 1955", "Special Marriage Act 1954", "Dissolution of Muslim Marriages Act 1939", "Divorce Act 1869", "Family Courts Act 1984"],
    courts: ["Family Court", "District Court (where Family Court not established)", "Allahabad High Court"],
    keyAreas: [
      { heading: "Mutual Consent Divorce", body: "Mutual consent divorce under Section 13B HMA is the fastest route — requires 1 year of separation, agreed terms on maintenance, custody, and property, and a 6-month waiting period (which courts can waive after Amardeep Singh v. Harveen Kaur, 2017)." },
      { heading: "Contested Divorce", body: "A contested divorce can be filed on grounds listed in Section 13(1) HMA — cruelty, adultery, desertion (2+ years), conversion, mental disorder, leprosy, venereal disease, or renunciation. Contested divorces can take 3–7 years in courts." },
      { heading: "Alimony & Maintenance", body: "On divorce, permanent alimony can be claimed under Section 25 HMA. Interim maintenance during proceedings is available under Section 24 HMA. Courts consider income, assets, and standard of living of both parties." },
    ],
    commonScenarios: [
      { scenario: "Both spouses agree to separate", explanation: "File for mutual consent divorce under Section 13B HMA. The process requires filing a joint petition, waiting 6 months (waivable), and appearing for the second motion. It is the fastest and least adversarial route." },
      { scenario: "Spouse is refusing divorce but marriage has broken down", explanation: "File for contested divorce on applicable grounds under Section 13(1) HMA. Cruelty is the most commonly pleaded ground and can include mental cruelty established through evidence of conduct." },
    ],
    faqs: [
      { q: "What are the grounds for divorce under Hindu Marriage Act 1955?", a: "Section 13(1) HMA provides the following grounds: adultery, cruelty (physical or mental), desertion for 2+ years, conversion to another religion, incurable unsoundness of mind, leprosy (virulent and incurable), venereal disease in communicable form, renunciation of the world, and being not heard of as alive for 7 years. Section 13(2) provides additional grounds available only to wives." },
      { q: "Can divorce be obtained without going to court in India?", a: "For Hindus, court proceedings are mandatory for a valid divorce — there is no administrative divorce process. Muslim men can pronounce talaq but instant triple talaq is now a criminal offence (Muslim Women Act 2019). However, after Shayara Bano (2017), only valid forms of talaq through proper process are recognised. For all religions, a court-obtained divorce decree is the most legally sound route." },
    ],
    relatedBlogs: ["mutual-consent-divorce-india-section-13b", "child-custody-law-india", "alimony-maintenance-india-law", "domestic-violence-law-india-pwdva"],
  },
];
